...
const Home = () => {
        ...
        allServicesResponse.data.forEach((service) => {
          if (service.category && !uniqueCategories.has(service.category._id)) {
            uniqueCategories.set(service.category._id, {
              ...
              image:
                service.images?.[0] ||
                getDefaultCategoryImage(service.category.name),
            });
          }
        });
  ...
  const getDefaultCategoryImage = (categoryName) => {
    const images = {
      ...
      Electrical:
        "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?q=80&w=240&auto=format&fit=crop",
      Catering:
        "https://images.unsplash.com/photo-1555244162-803834f70033?q=80&w=240&auto=format&fit=crop",
      Photography:
        "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=240&auto=format&fit=crop",
      Gardening:
        "https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?q=80&w=240&auto=format&fit=crop",
      Cleaning:
        "https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=240&auto=format&fit=crop",
    };
    return (
      images[categoryName] ||
      "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=240&auto=format&fit=crop"
    );
  };
  ...
  const promotionalBanners = [
    {
      ...
      description:
        "Professional photographers for your special occasions. Limited time offers!",
      image:
        "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=2089&auto=format&fit=crop",
    ...
    },
    {
      ...
      highlight: "Catering",
      description:
        "Exquisite food and service for your events and gatherings. Start from $299.",
      image:
    ...
    },
    {
      ...
      description:
        "Professional IT support and computer repair services. Book now and get 15% off!",
      image:
        "https://images.unsplash.com/photo-1558458878-36c4321e1e82?q=80&w=2070&auto=format&fit=crop",
      ...
      >
        <div className="logo">
          ...
          >
            ...
            <path
              d="M8 12C8 10.8954 8.89543 10 10 10H20C21.1046 10 22 10.8954 22 12V14C22 15.1046 21.1046 16 20 16H10C8.89543 16 8 15.1046 8 14V12Z"
              fill="white"
            />
            <path
              d="M10 18C10 17.4477 10.4477 17 11 17H19C19.5523 17 20 17.4477 20 18V20C20 20.5523 19.5523 21 19 21H11C10.4477 21 10 20.5523 10 20V18Z"
              fill="white"
            />
          </svg>
        ...
        <div className="services-header">
          ...
          <div className="scroll-controls">
            <button
              ...
              onClick={() => scrollServices("left", servicesRef)}
            >
              <span>←</span>
            </button>
            <button
              className="scroll-button"
              onClick={() => scrollServices("right", servicesRef)}
            >
              <span>→</span>
            </button>
          </div>
      ...
      <section className="featured-vendors-section" ref={featuredVendorsRef}>
        <div className="services-header">
          ...
          <div className="scroll-controls">
            <button
              className="scroll-button"
              onClick={() => scrollServices("left", featuredVendorsRef)}
            >
              <span>←</span>
            </button>
            <button
              className="scroll-button"
              onClick={() => scrollServices("right", featuredVendorsRef)}
            >
              <span>→</span>
            </button>
          </div>
      ...
      <section className="categories-section" ref={categoriesRef}>
        ...
        <div className="categories-scroll-container">
          <button
            ...
            onClick={() => scrollServices("left", categoriesRef)}
          >
            <span>←</span>
          </button>
          ...
          <button
            ...
            onClick={() => scrollServices("right", categoriesRef)}
          >
            <span>→</span>
          </button>
        </div>
        ...
        <div className="app-content">
          <div className="app-description">
            <div className="chat-bubble">
              ...
              <p>
                Tell Migo and get connected with the right service providers
              </p>
            </div>
            <h2>Mobile App Coming Soon</h2>
            <p>
              We're developing a feature-rich mobile experience to help you find
              and book services on the go. Stay tuned for our launch!
            </p>
        ...
        {promotionalBanners.map((banner) => (
          <div key={banner.id} className="promo-banner">
            <div className="promo-content">
              ...
              {banner.highlight && (
                <h2 className="promo-highlight">{banner.highlight}</h2>
              )}
            ...
            <div className="chat-messages">
              <div className="message bot">
                ...
                <div className="message-content">
                  Hi there! I'm Migo's AI assistant. How can I help you find
                  services today?
                </div>
              </div>
            </div>
