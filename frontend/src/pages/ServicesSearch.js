    ...
    <div className="services-search">
      <div className="search-container">
        ...
        <div className="search-header">
          ...
          {filters.location && (
            <p>Services near: <strong>{filters.location}</strong></p>
          )}
          {pagination.total && (
                    ...
                    <div className="service-content">
                      ...
                      <div className="service-footer">
                        <div className="service-rating">
                          ...
                          <span className="reviews">({service.reviewCount || 0})</span>
                        </div>
                      ...
                      <div className="service-location">
                        📍 {service.location.type === 'remote' ? 'Remote' : 
                             service.location.serviceArea?.cities?.slice(0, 2).join(', ') || 
                             'Multiple locations'}
                      </div>
                    </div>
                  </Link>
