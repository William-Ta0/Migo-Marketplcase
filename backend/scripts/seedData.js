...
const createSampleServices = async (categories, users) => {
  ...
  services.push({
    ...
    description: "Fast and reliable emergency plumbing services available 24/7. I handle all types of plumbing emergencies including burst pipes, clogged drains, water heater issues, and toilet repairs. Licensed and insured with over 15 years of experience.",
    shortDescription: "24/7 emergency plumbing repairs for all your urgent needs",
    vendor: mikeUser._id,
    category: {
      id: homeCategory._id,
    ...
    features: ["24/7 Emergency Service", "Licensed & Insured", "Free Estimates", "Satisfaction Guaranteed"],
  ...
  const personalCategory = categories.find(c => c.slug === 'personal-services');
  const sarahUser = users.find(u => u.name === 'Sarah Williams');
  
  services.push({
    title: "Personal Fitness Training & Nutrition Coaching",
    description: "Transform your body and mind with personalized fitness training and nutrition coaching. I create custom workout plans tailored to your goals, whether it's weight loss, muscle building, or overall health improvement. Includes meal planning and ongoing support.",
    shortDescription: "Personalized fitness training with custom workout and nutrition plans",
      ...
      packages: [
        {
          ...
          price: 280,
          features: ["4 one-on-one sessions", "Basic nutrition plan", "Exercise demonstrations"],
          deliveryTime: 30
        },
        {
          ...
          price: 750,
          features: ["12 one-on-one sessions", "Comprehensive nutrition plan", "Progress tracking", "24/7 support"],
          deliveryTime: 90
        }
      ]
    },
    ...
    features: ["Certified Trainer", "Custom Meal Plans", "Progress Tracking", "Flexible Scheduling"],
    tags: ["fitness", "training", "nutrition", "weight-loss"],
    requirements: ["Health clearance", "Fitness goals discussion"],
    deliverables: ["Custom workout plan", "Nutrition guide", "Progress reports"],
  ...
  services.push({
    ...
    description: "Professional web application development using modern technologies like React, Node.js, and MongoDB. I specialize in creating responsive, user-friendly applications that meet your business needs. From concept to deployment, I handle the entire development process.",
    shortDescription: "Full-stack web development with React, Node.js, and modern technologies",
    ...
    features: ["Responsive Design", "Modern Tech Stack", "SEO Optimized", "Mobile-First", "Security Best Practices"],
    tags: ["web development", "react", "nodejs", "full-stack"],
    requirements: ["Project requirements document", "Design preferences", "Timeline expectations"],
    deliverables: ["Source code", "Documentation", "Deployment", "Training session"],
  ...
  services.push({
    ...
    description: "Licensed electrician providing safe and reliable electrical services for your home. Services include outlet installation, lighting upgrades, electrical panel upgrades, and troubleshooting electrical issues. All work meets local codes and safety standards.",
    ...
    features: ["Licensed & Bonded", "Code Compliant", "Safety Guaranteed", "Emergency Service"],
    tags: ["electrical", "installation", "repair", "licensed"],
    requirements: ["Access to electrical panel", "Clear description of electrical issue"],
    deliverables: ["Professional electrical work", "Code compliance certificate", "Warranty"],
  ...
  const businessCategory = categories.find(c => c.slug === 'business-services');
  const jamesUser = users.find(u => u.name === 'James Park');
  
  services.push({
    title: "Digital Marketing Strategy & Implementation",
    description: "Comprehensive digital marketing services to grow your business online. I help businesses increase their online presence through SEO, social media marketing, content creation, and paid advertising campaigns. Data-driven approach with measurable results.",
    shortDescription: "Complete digital marketing solutions to grow your business online",
    ...
    pricing: {
      ...
      packages: [
        ...
        },
        {
          ...
          price: 1200,
          features: ["Full marketing strategy", "Campaign management", "Monthly reports", "Ongoing optimization"],
          deliveryTime: 30
        }
      ]
    },
    ...
    features: ["Data-Driven Results", "Custom Strategy", "ROI Tracking", "Ongoing Support"],
...
const seedDatabase = async () => {
  try {
    ...
    await User.deleteMany({ role: 'vendor', firebaseUid: { $regex: /^sample-vendor/ } });
