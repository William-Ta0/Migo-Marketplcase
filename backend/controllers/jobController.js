        ...
        vendor: [
          {
            status: "reviewing",
            label: "Start Review",
            description: "Begin reviewing the job request",
          },
          {
            status: "accepted",
            label: "Accept Job",
            description: "Accept the job request directly",
          },
          {
            status: "rejected",
            label: "Reject Job",
            description: "Decline the job request",
          },
        ],
        customer: [
          {
            ...
            description: "Cancel the job request",
          },
        ],
      },
      reviewing: {
        vendor: [
          {
            status: "quoted",
            label: "Send Quote",
            description: "Provide a custom quote",
          },
          {
            status: "accepted",
            label: "Accept Job",
            description: "Accept with current terms",
          },
          {
            status: "rejected",
            label: "Reject Job",
        ...
        vendor: [
          {
            ...
            description: "Accept with original terms",
          },
          {
            status: "rejected",
            label: "Reject Job",
        ...
        customer: [
          {
            status: "confirmed",
            label: "Accept Quote",
            description: "Accept the quote and proceed",
          },
          {
            status: "cancelled",
            label: "Cancel Request",
        ...
        customer: [
          {
            status: "confirmed",
            label: "Confirm & Pay",
            description: "Confirm the job and make payment",
          },
          {
            status: "cancelled",
            label: "Cancel Job",
        ...
        customer: [
          {
            status: "cancelled",
            label: "Cancel Job",
            description: "Cancel the job (may incur fees)",
          },
        ],
      },
      in_progress: {
        ...
        customer: [
          {
            ...
            description: "Accept the completed work",
          },
          {
            status: "disputed",
            label: "Dispute Work",
            description: "Raise concerns about the work",
          },
        ],
      },
      delivered: {
        ...
        customer: [
          {
            status: "closed",
            label: "Close Job",
            description: "Close the job successfully",
          },
        ],
      },
      cancelled: {
        ...
        vendor: [
          {
            status: "closed",
            label: "Resolve & Close",
            description: "Resolve dispute and close job",
          },
        ],
        customer: [
          {
